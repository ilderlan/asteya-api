package br.com.asteya.api.exceptionhandler;
...
public class AsteyaExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest webRequest){
    ...
    private static class Erro{
        @Getter
        private String mensagemUsuari;
        @Getter
        private String mensagemDesenvolvedor;

        private Erro(String mensagemUsuari, String mensagemDesenvolvedor) {
            this.mensagemUsuari = mensagemUsuari;
